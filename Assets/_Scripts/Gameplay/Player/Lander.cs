...
namespace My.Scripts.Gameplay.Player
{
    public class Lander : Singleton<Lander>
    {
        ...
        // ƒл€ обратной совместимости
        public void SetFuel(float addAmount) => AddFuel(addAmount);

        #endregion

        #region Public Methods Ч Velocity
        ...
        public void HandleCratePickup()
        {
            ...
            // —павним верЄвку с €щиком в позиции лендера
            // RopeWithCrate сам найдЄт Lander.Instance и настроит всЄ в Start()
        ...
        #region Private Methods Ч State Handling
        ...
        #region Private Methods Ч Input & Movement
        ...
        #region Private Methods Ч Collision

        private void HandleCollision(Collision2D collision)
        {
            // ѕровер€ем, это посадочна€ площадка?
        ...
        {
            // ”ничтожаем Rigidbody чтобы зафиксировать позицию
            Destroy(_rigidbody);
        ...
        #region Private Methods Ч Triggers
        ...
        #region Private Methods Ч Event Broadcasting
