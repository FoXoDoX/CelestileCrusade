...
namespace My.Scripts.Input
{
    public class GameInput : Singleton<GameInput>
    {
        ...
        /// <summary>
        /// ќтключает только геймплейные действи€ (движение, рестарт),
        /// но оставл€ет Menu (Esc) активным дл€ паузы.
        /// </summary>
        public void DisableGameplayInput()
        {
            ...
            // Menu остаЄтс€ включЄнным!

            _inputActions.Camera.Disable();
        }

        /// <summary>
        /// ¬ключает все геймплейные действи€ обратно.
        /// </summary>
        public void EnableGameplayInput()
        {
            ...
            _inputActions.Player.Menu.Enable(); // Ќа вс€кий случай
