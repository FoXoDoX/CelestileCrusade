...
namespace My.Scripts.Managers
{
    public class SoundManager : PersistentSingleton<SoundManager>
    {
        ...
        private void SubscribeToEvents()
        {
            ...
            // —обыти€ с параметром PickupEventData
            ...
            // —обытие с параметром LanderLandedData
        ...
        // ќбработчики с параметром PickupEventData (данные игнорируем, нужен только звук)
